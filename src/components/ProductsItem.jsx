...
export default function ProductsItem(props) {
  return (
    <div className="w-full grid grid-cols-4 items-center  my-5 rounded-lg shadow-lg bg-white p-2">
      ...
      <div className="text-center m-auto">
        <p className="font-bold">{props.offerPrice}</p>
        <p className="font-bold text-zinc-400">{props.price}</p>
      </div>
      <div className="text-black m-auto">
        <button className="bg-yellow-500 mx-3 my-2 rounded-sm flex items-center p-[2px] justify-center font-bold">
          <PencilSquareIcon className="w-5 mx-1" />
        </button>
        <button className="bg-red-500 mx-3 my-2 rounded-sm flex items-center p-[2px] justify-center font-bold">
