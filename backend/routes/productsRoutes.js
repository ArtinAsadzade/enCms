...
productsRouter.get("/", (req, res) => {
  ...
  EnCmsDB.query(selectAllProductsQuery, (err, result) => {
...
productsRouter.delete("/:productID", (req, res) => {
  ...
  EnCmsDB.query(deleteProductQuery, (err, result) => {
    if (err) {
      res.send(null);
    } else {
      res.send(result);
...
productsRouter.put("/:productID", (req, res) => {
  ...
  EnCmsDB.query(updateProductQuery, (err, result) => {
    if (err) {
      console.log(err);
      res.send(null);
    } else {
...
productsRouter.post("/", (req, res) => {
  ...
  EnCmsDB.query(addNewProductQuery, (err, result) => {
    if (err) {
      console.log(err);
      res.send(null);
    } else {
